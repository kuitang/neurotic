function F=makeBarFilters(sup, or, sc)

% modified version of code provided at
% http://www.robots.ox.ac.uk/~vgg/research/texclass/filters.html
% see this website for details.

  SUP=sup;                 % Support of the largest filter (must be odd)
  SCALEX=sqrt(2).^[1:sc];  % Sigma_{x} for the oriented filters
  NORIENT=or;              % Number of orientations
